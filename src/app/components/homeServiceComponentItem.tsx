...
export default function HomeServiceComponentItem({ item }: HomeServiceComponentItemProps) {
    ...
    return (
        ...
        // }}
        className="group item home--service-item relative overflow-hidden group !opacity-100" key={item.id}>
            <div className="content z-10 relative">
                ...
                <p className='text-white dark:text-gray-950  transition delay-100 duration-300'>{item.description}</p>
            </div>
